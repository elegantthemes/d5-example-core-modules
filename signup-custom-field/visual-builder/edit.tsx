 ...
 * @since ??
 *
 * @param { SignupCustomFieldEditProps} props React component props.
 *
 * @returns {ReactElement}
 */
const SignupCustomFieldEdit = ({
  attrs,
  id,
  name,
  elements,
  ...
  useEffect(() => {
    setIsLastItem(siblings.find(sibling => sibling.id === id)?.isLastInput ?? false);
  ...
  return (
    <ModuleContainer
      ...
      className={isLastItem ? 'et_pb_contact_field_last' : ''}
      isLooped={isLooped}
      loopIndex={loopIndex}
    >
