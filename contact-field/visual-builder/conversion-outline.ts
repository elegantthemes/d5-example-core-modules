...
// wp.data.select('divi/settings').getSetting('shortcodeModuleDefinitions').et_pb_contact_field.fields
...
/**
 * This function parses conditional logic rules from D4 URL-encoded JSON string.
 *
 * @since ??
 *
 * @param {string} value URL-encoded JSON string from D4 conditional logic rules.
 *
 * @returns {ContactFieldCondition[]} Array of conditional logic rule objects.
 */
const conditionalLogicConverter = (value: string): ContactFieldCondition[] => {
